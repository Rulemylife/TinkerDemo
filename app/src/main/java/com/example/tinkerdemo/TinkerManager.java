...
public class TinkerManager {
    ...
    public static void installTinker(ApplicationLike appLike) {
        if (isInstalled) {
            ShareTinkerLog.d(TAG, "install tinker, but has installed, ignore");
            return;
        }
        //or you can just use DefaultLoadReporter
        LoadReporter loadReporter = new TinkerLoaderReport(appLike.getApplication());
        //or you can just use DefaultPatchReporter
        PatchReporter patchReporter = new TinkerPathReporter(appLike.getApplication());
